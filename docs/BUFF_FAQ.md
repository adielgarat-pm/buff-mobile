...
**Long:** *Everything the family uses day to day is free, with no time limit and no card: unlimited children, unlimited tasks, BUDDY and its skins, BUFFs, the rewards shop and real-reward redemption, Vibe Check, SOS, Pause Mode and Anchor, notifications, the class timetable (typed in), activities, bag prep and off-routine days. The only paid part is **BUFF Coach**, for parents: the AI coach (weekly insights about your child and recommendations), AI capture (a photo or a note turned into tasks) and importing the class timetable from a photo (every family gets one free import). It costs $59.99/year or $9.99/month and renews automatically until you cancel. Every family gets 14 days of BUFF Coach free, starting when their child completes a first task — no card is needed and nothing is charged when the 14 days end; you only pay if you choose to subscribe. After that you still get one free coach insight every week. No ads, ever.*

**HE (long):** *כל מה שהמשפחה משתמשת בו ביום-יום חינם, בלי הגבלת זמן ובלי כרטיס: ילדים ומשימות בלי הגבלה, BUDDY והסקינים, BUFFs, חנות הפרסים ומימוש פרסים אמיתיים, Vibe Check, SOS, Pause ו-Anchor, התראות, מערכת שעות (בהזנה ידנית), פעילויות, הכנת תיק וימים מחוץ לשגרה. החלק היחיד בתשלום הוא **BUFF Coach** להורים: מאמן ה-AI (תובנות שבועיות על הילד והמלצות), קליטה חכמה (תמונה או טקסט שהופכים למשימות) וייבוא מערכת השעות מתמונה (כל משפחה מקבלת ייבוא אחד בחינם). ‎$59.99 לשנה או ‎$9.99 לחודש, מתחדש אוטומטית עד שמבטלים. כל משפחה מקבלת 14 יום של BUFF Coach בחינם מהרגע שהילד משלים משימה ראשונה — בלי כרטיס, ושום דבר לא מחויב בסוף 14 הימים; משלמים רק אם בוחרים להירשם. אחרי זה עדיין מקבלים תובנה אחת בחינם כל שבוע. בלי פרסומות, לעולם.*
