...
| `fb-cover-founder-2026-07-24.png` | Facebook cover photo — brand violet **gradient** (matching the official Play Store feature graphic) + real logo. Hero "Stop fighting task time. Start coaching it." (canonical BRAND §3.3 — replaced an earlier "Stop nagging" hero that violated COMPETITORS §3.1: Joon owns the word "nagging") · wordmark "BUFF ADHD" · kicker "ADHD support · Routines · Ages 6–18" · mission tagline "Until they don't need us." moved to subhead · credibility line "Co-designed with my 15-year-old with ADHD — for kids like him." 3280×1248 (2× of 1640×624 FB upload size). Brand-exact (BRAND §7.2 tokens, spaceship-test compliant). Copy refined 2026-07-24 vs a second-opinion critique (hero was mission tagline; moved down for clarity-led hero). | Adi's FB profile refurbish — [MARKETING_BACKLOG Track H / H-1](../BUFF_MARKETING_BACKLOG.md#66-track-h--group-reputation--profile-as-landing-page-brief) |
