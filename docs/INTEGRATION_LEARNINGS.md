...
- **סטטוס:** `open` — הקוד נדחף; ממתין לאימות דומיין ב-Vercel + אימות אצל משתמש אמיתי מהקבוצה
