...
- **סטטוס:** `code-complete-pending-Hat-3/4` — branch `fix/duplicate-child-guard`. DB layer live + verified; Hat-3 (emulator: add same child twice → dialog; delete child works) + Hat-4 pending.
