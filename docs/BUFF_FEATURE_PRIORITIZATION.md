...
| F-071 | Translate review (dynamic i18n for user-generated content) | System | Out | M | Phase 2 | D-2026-05-14: source = Lovable translate-review edge function; relevant only after international expansion. |
...
| F-074 | Static marketing landing (buffadhd.com revamp) | System | Should Have | M | Phase 2 | D-2026-05-14: source = Lovable Landing.tsx; separate codebase from app (no logic-sharing needed for a static marketing site). |
| F-075 | Sunset Lovable (notify 2 active users + decommission infra) | System | Should Have | S | Phase 2 | D-2026-05-14: 49 Lovable sign-ups, only 2 active per admin (verified 2026-05-14). Manual self-migration. Trigger date: after MVP stable in production + 30-day observation window. |
