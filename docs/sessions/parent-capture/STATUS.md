...
**Open (Adi):** rename — recommended **"מארגן חכם" / "Smart Organizer"**, sub-line "מהודעה או קובץ → משימות התארגנות לילדים", button "תעשה לי סדר". i18n strings only (`capture.*` keys unchanged), so it can land any time.
