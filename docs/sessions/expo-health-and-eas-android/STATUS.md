...
| 4 — Play Console Internal Testing upload | _in_progress_ | 2026-05-16 | — | Adi at "שמור ופרסם" step for v8. Adding more testers + publishing without mapping (mapping deferred to Sentry package). | — |
