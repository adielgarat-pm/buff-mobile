...
-- any mobile-onboarded child (pro_settings->'onboarding_data'); LEFT JOIN keeps
-- childless signups visible.

CREATE OR REPLACE FUNCTION public.get_admin_tester_board(p_since date DEFAULT '2026-05-20')
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
GRANT EXECUTE ON FUNCTION public.get_admin_tester_board(date) TO authenticated;
