...
export function fakeJwt(user) {
  ...
  // Like real GoTrue, every session gets its own token (session_id): two
  // sessions minted in the same second used to be byte-identical here (B6
  // flaked in CI, 2026-09-25).
